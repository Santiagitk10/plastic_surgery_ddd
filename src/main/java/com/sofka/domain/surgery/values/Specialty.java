...
public class Specialty implements ValueObject<String> {
    ...
    public Specialty(String value) {
        ...
        if(this.value.isBlank()){
            throw new IllegalArgumentException("The VO Specialty cannot be blank");
        }
        if(this.value.length() < 5){
            throw new IllegalArgumentException("The VO Specialty cannot have less than 5 letters");
        }
    }
